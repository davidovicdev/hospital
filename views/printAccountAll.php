<?php
if (isset($_GET["printAccountAll"]) and !empty($_GET["printAccountAll"])) {
    $printId = $_GET["printAccountAll"];
    ...
    <div class="modal2">
        ...
        <div class="modal2-body fc">
            ...
            <div class="print mr10 ml10">
                <p>Slipper Format</p>
                <a class='buttonForPrintSliperAll fc' data-id="<?php echo $printId ?>"><?php echo $printslipper ?></a>
