...
try {
    ...
    foreach ($result as $r) {
        $idAcc = +$r->accountId;
        $query1 = "SELECT therapyPrice FROM accounts WHERE id_account = $idAcc";
        ...
        if ($resultForGreen) {
            $output .= "<div class='no-vab head-tcss fc poppins wght600 green-check $class copyClass'>";
        } else {
            $output .= "<div class='no-vab head-tcss fc poppins wght600 orange-check $class copyClass'>";
        }
