...
// CHECK FOR ID_ACCOUNT IF IT EXISTS IN ACCOUNTS TABLE
try {
    include_once("data/connection.php");
    global $con;
    $query = "SELECT * FROM accounts WHERE id_account = $idAccount";
...
<div class="overlayblack">
    <div class="modal modal-s">
        ...
        <div class="modal-body scroll" id="flyingContainterUpdate">
            ...
            $queryForDoctor = "SELECT name,surname, a.id_employee as employeeId FROM accounts a INNER JOIN employees e ON a.id_employee = e.id_employee WHERE id_account = $idAccount";
            ...
            echo $output;
            ?>
            <div class="buidl-nalog-body modal-m mt20">
                            ...
                            <div class="accordion1-header js-accordion3-header bluedrop fb">
                                ...
                                <div class="price">
                                    ...
                                    <span id='totalPriceAppointmentsUpdate'><?php
                                                                            $result = $con->query("SELECT appointmentPrice FROM accounts WHERE id_account = $idAccount")->fetch();
                                        ...
                                        <div class="">
                                            <div class="fconly">
                                                ...
                                                <select class="select-list1 pr10 scroll2" name="finalAppointmentsUpdate" id="finalAppointmentsUpdate" size="5" multiple>
                                                    <?php
                                                    try {
                                                        $query = "SELECT DISTINCT * FROM accounts a INNER JOIN accounts_appointments aa ON a.id_account = aa.id_account INNER JOIN appointments app ON app.id_appointment = aa.id_appointment WHERE a.id_account= $idAccount";
                                                        $output = "";
                                                        $result = $con->query($query)->fetchAll();
                                                        foreach ($result as $r) {
                            ...
                            <div class="accordion1-header js-accordion3-header bluedrop fb">
                                ...
                                <div class="price">
                                    ...
                                    <span id='totalPriceBloodsUpdate'><?php
                                                                        $query = "SELECT bloodPrice FROM accounts WHERE id_account = $idAccount";
                                                                        $result = $con->query($query)->fetch();
                                    ...
                                    <div class="">
                                        ...
                                        <div class="">
                                            <div class="fc">
                                                ...
                                                <div id="searchBloodResultUpdate"></div>
                                                <select class="select-list1 pr10 scroll2" name="bloodUpdate" id="bloodUpdate" size="11" multiple>
                                                    <?php
                                                    try {
                                                        include_once("data/connection.php");
                                                        global $con;
                                                ...
                                                <select class="select-list1 pr10 scroll2" name="finalBloodsUpdate" id="finalBloodsUpdate" size="11" multiple>
                                                    <?php
                                                    try {
                                                        $query = "SELECT DISTINCT * FROM accounts a INNER JOIN accounts_bloods ab ON a.id_account = ab.id_account INNER JOIN bloods b ON b.id_blood = ab.id_blood WHERE a.id_account= $idAccount";
                                                        $output = "";
                                                        $result = $con->query($query)->fetchAll();
                                                        foreach ($result as $r) {
                                            ...
                                            <div class="fc matuo">
                                                ...
                                                <button class="select-list1-btn s-l1-btn2 btn brbr16" id="moveFromFinalBloodsUpdate">-</button>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="accordion1__item js-accordion3-item">
                        <div class="accordion1-header js-accordion3-header bluedrop fb">
                            ...
                            <div class="price">
                                ...
                                <span id='totalMedicinesPriceUpdate'><?php
                                                                        $resultMedicines = $con->query("SELECT therapyPrice FROM accounts WHERE id_account = $idAccount")->fetch();
                        ...
                        <div class="accordion1-body js-accordion3-body brbl16 brbr16">
                            ...
                            <p class='fs18 gray wght700'>Trenutni lekovi na ovom nalogu</p><p>Dodaj/Oduzmi lek</p><div id='medicinesUpdate' class='fav-medicines scroll2 mb20'>";
                                ...
                                </div><div class='mt20'><p class='ml20 wght600 txtc mb5'>Komentar:</p>
                                <textarea class='commentTherpay fc mb15 scroll2 modal-s'  name='commentUpdate' id='commentUpdate' cols='30' rows='10' >$resultQuery->comment</textarea>
                                <p class='ml20 wght600 txtc mb5'>Anamneza:</p>
                                <textarea class='commentTherpay fc mb15 scroll2 modal-s'  name='anamnezaUpdate' id='anamnezaUpdate' cols='30' rows='10' >$resultQuery->anamneza</textarea>
                                <p class='ml20 wght600 txtc mb5'>Nalaz:</p>
                                <textarea class='commentTherpay fc mb15 scroll2 modal-s'  name='nalazUpdate' id='nalazUpdate' cols='30' rows='10' >$resultQuery->nalaz</textarea>
                                <p class='ml20 wght600 txtc mb5'>UZ Nalaz:</p>
                                <textarea class='commentTherpay fc mb15 scroll2 modal-s'  name='uznalazUpdate' id='uznalazUpdate' cols='30' rows='10' >$resultQuery->uznalaz</textarea>
                                <p class='ml20 wght600 txtc mb5'>Terapija:</p>
                                <textarea class='commentTherpay fc mb15 scroll2 modal-s'  name='terapijaUpdate' id='terapijaUpdate' cols='30' rows='10' >$resultQuery->terapija</textarea>
                                <p class='ml20 wght600 txtc mb5'>Zaključak:</p>
                                <textarea class='commentTherpay fc mb15 scroll2 modal-s'  name='zakljucakUpdate' id='zakljucakUpdate' cols='30' rows='10' >$resultQuery->zakljucak</textarea>
                                                <div class='fdcolumn totalPriceAccountClass'><span id='totalAccountPriceUpdate' class='updatePriceResult fc'>Ukupna cena naloga:  $totalAccountPriceUpdate RSD</span><button class='ukupnocena' data-idAccount='$idAccount' id='updateButton'>Izmeni</button></div>";
                                            echo $output;
                                        } else {
                                            // ! echo "Imamo rez za prvi SELECT";
                                            $output = "<p class='fs16 wght600 txtc gray2'>Pojedinačno dodavanje lekova</p>
                                            ...
                                            $output .= "</div></div></div>
                                                 ...
                                                 <p class='ml20 wght600 txtc mb5'>Zaključak:</p>
                                                 <textarea class='commentTherpay fc mb15 scroll2 modal-s'  name='zakljucakUpdate' id='zakljucakUpdate' cols='30' rows='10' >$resultQuery->zakljucak</textarea>
                                                                 <div class='fdcolumn totalPriceAccountClass'><span id='totalAccountPriceUpdate' class='updatePriceResult fc'>Ukupna cena naloga:  $totalAccountPriceUpdate</span><button class='ukupnocena' data-idAccount='$idAccount' id='updateButton'>Izmeni</button></div>";
                                            echo $output;
                                        }
                                    } catch (PDOException $e) {
                                        http_response_code(500);
