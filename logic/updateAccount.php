...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        $anamneza = $_POST["anamnezaUpdate"];
        $nalaz = $_POST["nalazUpdate"];
        $uznalaz = $_POST["uznalazUpdate"];
        $terapija = $_POST["terapijaUpdate"];
        $zakljucak = $_POST["zakljucakUpdate"];
        ...
        if ($medicinesIds != 0) {
            ...
            if (in_array(false, $array)) {
                ...
                $resultEditAccount = updateAccount($idDoctor, $comment, $anamneza, $nalaz, $uznalaz, $terapija, $zakljucak, $totalPriceBloods, $totalPriceMedicines, $totalPriceAppointments, $totalPrice, $idAccount);
