...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    try {
        ...
        foreach ($result as $r) {
            ...
            if ($resultForGreen) {
                $output .= "<div class=' no-vab head-tcss fc poppins wght600 green-check copyClass $class'>";
            } else {
                $output .= "<div class=' no-vab head-tcss fc poppins wght600 orange-check copyClass $class'>";
            }
            $output .= "$r->accountId <div class='hiddenDiv'>$r->jmbg</div></div>
            ...
            if (in_array($_SESSION["id_role"], [2, 5])) {
                $cek = "<form class='form'>
                        ...
                        <div class='inputGroup'>
                            ...
                            <label for='option1'>Čekiraj</label>
                        </div>
        ...
        if ($pageCount > 1) {
            $output .= "<div class='paginationFront scroll2'><ul class='pagination fc' class='paginationAccount'>";
