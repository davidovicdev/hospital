...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    try {
        ...
        $output .= "<div class='modal container85'><div class='modal-header'><p>IZDATI NALOZI DOKTORA</p><div class='close-button closeMe'>$deletesvg</div></div><div class='modal-body scroll'>";
        foreach ($result as $r) {
        ...
        $output .= "</div></div>"; // OD CONTAINERA DIV
        if ($pageCount > 1) {
